...
class Quotes extends React.Component{
    constructor(){
        super();
        this.state={
            quotation : "practice makes man perfect"
        }
    }
    ...
    let finalquotes = quotes[randomquotes]
    this.setState({quotation : finalquotes})
    ...
    render(){
        return(
            <div className="colors">
                <h1>Random Quotes</h1>
                <h2>{this.state.quotation}</h2>
                <button onClick={this.quotesHandler}>Randeom quotes</button>
            </div>
        )
    }
}
